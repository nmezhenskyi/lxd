...
test_clustering_link_auth() {
  ...
  [ "$(CLIENT_DEBUG="" SHELL_TRACING="" LXD_DIR="${LXD_ONE_DIR}" lxc cluster link set lxd_two volatile.addresses=99.99.99.99:8443 2>&1)" = 'Error: Configuration key "volatile.addresses" cannot be set directly' ]
