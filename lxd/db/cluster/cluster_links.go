...
func CreateClusterLinkConfig(ctx context.Context, tx *sql.Tx, name string, config map[string]string) error {
	...
	err = clusterLinkConfigAdd(ctx, tx, id, config)
	if err != nil {
		return err
	}
...
func UpdateClusterLinkConfig(ctx context.Context, tx *sql.Tx, name string, config map[string]string) error {
	...
	err = clearClusterLinkConfig(ctx, tx, id)
	if err != nil {
		return err
	}
...
func clusterLinkConfigAdd(ctx context.Context, tx *sql.Tx, clusterLinkID int64, config map[string]string) error {
...
func clearClusterLinkConfig(ctx context.Context, tx *sql.Tx, clusterLinkID int64) error {
