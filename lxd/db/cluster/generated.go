...
// CreateValues returns a list of values from [ClusterLinkRow] entities matching the columns returned from CreateColumns.
...
// CreateValues returns a list of values from [ImageRegistryRow] entities matching the columns returned from CreateColumns.
