...
func getClusterLinks(ctx context.Context, stmt *sql.Stmt, args ...any) ([]ClusterLink, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("Failed fetching from \"cluster_links\" table: %w", err)
	}
...
func GetClusterLinks(ctx context.Context, tx *sql.Tx, filters ...ClusterLinkFilter) ([]ClusterLink, error) {
	...
	if len(filters) == 0 {
		...
		if err != nil {
			return nil, fmt.Errorf("Failed getting \"clusterLinkObjects\" prepared statement: %w", err)
		}
	}
	...
	for i, filter := range filters {
		if filter.Name != nil && filter.ID == nil {
			...
			if len(filters) == 1 {
				...
				if err != nil {
					return nil, fmt.Errorf("Failed getting \"clusterLinkObjectsByName\" prepared statement: %w", err)
				}
			...
			if len(filters) == 1 {
				...
				if err != nil {
					return nil, fmt.Errorf("Failed getting \"clusterLinkObjectsByID\" prepared statement: %w", err)
				}
...
func GetClusterLinkID(ctx context.Context, tx *sql.Tx, name string) (int64, error) {
	...
	if err != nil {
		return -1, fmt.Errorf("Failed getting \"clusterLinkID\" prepared statement: %w", err)
	}
	...
	if err != nil {
		...
		return -1, fmt.Errorf("Failed getting \"cluster_links\" ID: %w", err)
	}
...
func CreateClusterLink(ctx context.Context, tx *sql.Tx, object ClusterLink) (int64, error) {
	...
	if err != nil {
		return -1, fmt.Errorf("Failed getting \"clusterLinkCreate\" prepared statement: %w", err)
	}
	...
	if err != nil {
		...
		return -1, fmt.Errorf("Failed creating \"cluster_links\" entry: %w", err)
	}

	id, err := result.LastInsertId()
	if err != nil {
		return -1, fmt.Errorf("Failed fetching \"cluster_links\" entry ID: %w", err)
	}
...
func UpdateClusterLink(ctx context.Context, tx *sql.Tx, name string, object ClusterLink) error {
	...
	if err != nil {
		return fmt.Errorf("Failed getting \"clusterLinkUpdate\" prepared statement: %w", err)
	}
...
func DeleteClusterLink(ctx context.Context, tx *sql.Tx, name string) error {
	...
	if err != nil {
		return fmt.Errorf("Failed getting \"clusterLinkDeleteByName\" prepared statement: %w", err)
	}
...
func RenameClusterLink(ctx context.Context, tx *sql.Tx, name string, to string) error {
	...
	if err != nil {
		return fmt.Errorf("Failed getting \"clusterLinkRename\" prepared statement: %w", err)
	}
