...
LXD currently supports one type of cluster link:

- **Bidirectional** (`bidirectional`): A mutually authenticated link between two clusters that can be used by both sides.
